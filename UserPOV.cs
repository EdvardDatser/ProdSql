...
namespace ProdSql
{
    public partial class Tooded_Poes : Form
    {
        ...
        public void Kategooriad()
        {
            ...
            connect.Open();
            adapter_kat = new SqlDataAdapter("SELECT Id, ProductName FROM KategooriaTable", connect);
            ...
            {
                kategooriad.TabPages.Add((string)nimetus["Kategooria_name"]);
                iconsList.Images.Add(Image.FromFile(@"..\..\Kat_pildid\" + (string)nimetus["Kategooria_name"] + ".jpg"));//
